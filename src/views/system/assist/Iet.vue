<template>
	<div class="iet area">
		<div class="layout">
			<el-popover ref="searchPopover" popper-class="searchPopover" placement="bottom-start">
				<el-form class="searchFrom" ref="searchFrom"  inline>
					<el-form-item>
						<el-input placeholder="请输入收支名称" v-model="searchFrom.name" clearable></el-input>
					</el-form-item>
					<el-form-item>
						<el-select v-model="searchFrom.type" placeholder="请选择收支类型" clearable>
		...
		<el-table :data="tableData" height="calc(100% - 90px)" border v-madeTable>
			<el-table-column prop="name" label="收支名称" align="center" width="120px"></el-table-column>
			<el-table-column prop="extension.type" label="收支类型" align="center" width="100px"></el-table-column>
			<el-table-column prop="sort" label="收支排序" align="center" width="100px"></el-table-column>
				...
				<template v-if="dialog">
					<el-form :model="form" :rules="rules" ref="form" label-width="80px" >
						...
						<el-form-item label="收支类型" prop="type">
							<el-select v-model="form.type" placeholder="请选择收支类型" clearable>
	...
	export default {
		...
		methods: {
			...
			record(page) {
				...
				this.$axios.post("iet/record", parm).then(result => {
			...
			save() {
				this.$refs["form"].validate(valid => {
					if (valid) {
						this.$axios.post("iet/save", this.form).then(result => {
							if (result.state == "success") {
								this.record(0);
								this.dialog = false;
