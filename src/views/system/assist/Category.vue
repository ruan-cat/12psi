		...
		<div class="layout">
            <div style='flex:1;display:flex;align-items: center;'>
				<el-form class="searchFrom" ref="searchFrom"  inline>
					<el-form-item>
						<el-input placeholder="请输入类别名称" v-model="searchFrom.name" clearable></el-input>
					</el-form-item>
					<el-form-item>
						<el-button class="searchBtn"  @click="record(1)" @keyup.enter="mounted">搜索</el-button>
					</el-form-item>
				</el-form>
			</div>
			<el-button-group>
...
<script>
	...
	export default {
		...
		methods:{
			//获取数据
			record(){
				this.$axios.post("category/record",this.searchFrom).then(result => {
