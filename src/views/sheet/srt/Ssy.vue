	...
	<div class="ssy area">
		<div class="layout">
			<el-popover ref="searchPopover" popper-class="searchPopover" placement="bottom-start">
				<el-form class="searchFrom" ref="searchFrom" inline>
					...
					<el-form-item>
						<nodList ref="customer" v-model="searchFrom.customer" placeholder="请选择客户" action="service/customerRecord" scene="customer" :disabled='searchFrom.type!=1'></nodList>
					</el-form-item>
					<el-form-item>
					...
					<el-form-item>
						<el-select v-model="searchFrom.type" placeholder="查询类型" @change="typeChange">
							...
							<el-option label="按客户" :value="1"></el-option>
		...
		>
			<template v-if="tableType==1">
				<el-table-column prop="customer.name" label="客户" align="center" width="160px"></el-table-column>
			</template>
			...
			<el-table-column label="销售单" align="center">
				<el-table-column prop="sell.price" label="单价" align="center" width="90px"></el-table-column>
				<el-table-column prop="sell.nums" label="数量" align="center" width="90px"></el-table-column>
				<el-table-column prop="sell.money" label="金额" align="center" width="90px"></el-table-column>
			</el-table-column>
			<el-table-column label="销售退货单" align="center">
				<el-table-column prop="sre.price" label="单价" align="center" width="90px"></el-table-column>
				<el-table-column prop="sre.nums" label="数量" align="center" width="90px"></el-table-column>
				<el-table-column prop="sre.money" label="金额" align="center" width="90px"></el-table-column>
			</el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				page: {
					...
					count: 5,
					status:[
						{text:'销售总金额',type:'sum',key:'sell.money'},
						{text:'销售退货总金额',type:'sum',key:'sre.money'},
		...
		methods: {
			...
			record(page) {
				...
				this.$axios.post("srt/ssy", parm).then(result => {
			...
			exports(){
				...
				setTimeout(() => {
					window.open(this.$base.web+'srt/ssyExports?'+parm)
				}, 1000);
			},
			//页面刷新
			reload() {
