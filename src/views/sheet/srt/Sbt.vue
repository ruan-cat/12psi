<template>
	<div class="sbt area">
		...
		>
			...
			<el-table-column prop="money" label="单据收款" align="center" width="90px"></el-table-column>
			<el-table-column prop="balance" label="应收款余额" align="center" width="90px"></el-table-column>
			<el-table-column prop="rate" label="收款率" align="center" width="90px"></el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				page: {
					...
					count: 5,
					status:[
						{text:'应收款总余额',type:'sum',key:'balance'}
					]
				}
			};
		},
		...
		methods: {
			...
			record(page) {
				...
				this.$axios.post("srt/sbt", parm).then(result => {
			...
			exports(){
				...
				setTimeout(() => {
					window.open(this.$base.web+'srt/sbtExports?'+parm)
				}, 1000);
			},
			//页面刷新
			reload() {
