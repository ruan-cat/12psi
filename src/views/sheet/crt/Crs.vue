<template>
	<div class="crs area">
				...
				<el-form class="searchFrom" ref="searchFrom" inline>
					...
					<el-form-item>
						<el-select v-model="searchFrom.type" placeholder="数据类型">
							...
							<el-option label="欠款客户" :value="1"></el-option> 
						</el-select>
					</el-form-item>
					<el-form-item>
		...
		>
			...
			<el-table-column prop="name" label="客户" align="center" width="120px"></el-table-column>
			...
			<el-table-column prop="cw" label="增加应收款" align="center" width="100px"></el-table-column>
			<el-table-column prop="pia" label="增加预收款" align="center" width="100px"></el-table-column>
			<el-table-column prop="balance" label="应收款余额" align="center" width="100px"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			record(page) {
				...
				this.$axios.post("crt/crs", parm).then(result => {
			...
			exports(){
				...
				setTimeout(() => {
					window.open(this.$base.web+'crt/crsExports?'+parm)
				}, 1000);
			},
			//页面刷新
			reload() {
