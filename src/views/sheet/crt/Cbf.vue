<template>
	<div class="cbf area">
		...
		>
			...
			<el-table-column prop="name" label="账户名称" align="center" width="120px"></el-table-column>
			...
			<el-table-column prop="in" label="收入" align="center" width="100px"></el-table-column>
			<el-table-column prop="out" label="支出" align="center" width="100px"></el-table-column>
			<el-table-column prop="balance" label="账户余额" align="center" width="100px"></el-table-column>
			<el-table-column prop="sourceData.userData.name" label="制单人" align="center" width="100px"></el-table-column>
			<el-table-column prop="sourceData.data" label="备注" align="center" width="200px"></el-table-column>
		</el-table>
	...
	export default {
		...
		methods: {
			...
			record(page) {
				...
				this.$axios.post("crt/cbf", parm).then(result => {
			...
			exports(){
				...
				setTimeout(() => {
					window.open(this.$base.web+'crt/cbfExports?'+parm)
				}, 1000);
			},
			//页面刷新
			reload() {
